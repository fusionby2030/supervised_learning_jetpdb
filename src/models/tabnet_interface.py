...
class TABNETInterface(ModelInterface): 
    def __init__(self, params): 
        ...
        self.model_config =  TabNetModelConfig(task='regression', target_range=[(0.1, 15)], learning_rate=self.params['learning_rate'])
    def train(self, data):
        ...
        # print(y_train.shape, y_train.reshape(-1, 1).shape, X_train.shape)
