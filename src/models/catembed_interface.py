...
class CATEMBEDInterface(ModelInterface): 
    def __init__(self, params): 
        ...
        self.model_config =  CategoryEmbeddingModelConfig(task='regression', target_range=[(0.1, 15)], 
                                                          layers=params['layers'], embedding_dropout=params['embedding_dropout'], dropout=params['dropout'], learning_rate=self.params['learning_rate'])
    def train(self, data):
